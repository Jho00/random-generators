 ...
 * эта срань все равно будет давать постоянный 0. Метод древний, как говно мамонта, и не рабочий, как Тю после 3 литра пива.
 */
class NeymanGenerator implements IGenerator {
    private _nextNumber: number = 3466;
    generate(): number {
    ...
    private getNewNextNumber(): number {
        ...
        return Math.floor( ((sq * sq) % 1000000 ) / 100);
    }
